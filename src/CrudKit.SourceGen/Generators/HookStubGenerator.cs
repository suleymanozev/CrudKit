...
/// <summary>
/// Generates a partial hook stub class implementing ICrudHooks using the configured naming convention.
...
internal static class HookStubGenerator
{
    public static string Generate(EntityMetadata entity, NamingConvention naming)
    {
        ...
        sb.AppendLine($"/// </summary>");
        sb.AppendLine($"public partial class {className} : ICrudHooks<{entity.Name}>");
        sb.AppendLine("{");
